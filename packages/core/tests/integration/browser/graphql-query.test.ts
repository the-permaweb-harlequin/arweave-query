...
describe("Browser Integration - GraphQL Query", () => {
  ...
  it("should query transactions from GraphQL endpoint in browser", async () => {
    if (!hasGraphQLData) {
  ...
  it("should filter transactions by owner via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should filter transactions by block height range via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should filter transactions by tags via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should support pagination with cursor via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should query blocks from GraphQL endpoint in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should get a single transaction by id via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
  ...
  it("should handle recipients filter via GraphQL in browser", async () => {
    if (!hasGraphQLData) {
      console.log("Skipping - no GraphQL data available");
      return;
    }
